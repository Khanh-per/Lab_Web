...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- NAVBAR STYLES (From your snippet) --- */
        .navbar {
            background: white;
            padding: 15px 30px;
            margin-bottom: 30px;
        ...
        .navbar h2 { font-size: 20px; margin: 0; color: #333; display: flex; align-items: center; gap: 10px;}
        ...
        .role-user { background: #e2e3e5; color: #383d41; border: 1px solid #d6d8db; }

        .btn-nav { color: #555; text-decoration: none; font-weight: 500; font-size: 14px; transition: color 0.2s;}
        ...
        /* --- BUTTONS --- */
        .btn { padding: 10px 20px; text-decoration: none; border-radius: 4px; font-weight: 500; font-size: 14px; border: none; cursor: pointer; transition: all 0.2s; display: inline-flex; align-items: center; gap: 5px; }
        ...
        .btn-outline { background: transparent; border: 1px solid #6c757d; color: #6c757d; padding: 9px 15px; }
        .btn-outline:hover { background: #e2e6ea; }

        /* Table Action Buttons */
        .btn-edit { background: #ffc107; color: #212529; padding: 6px 12px; font-size: 13px; text-decoration: none; border-radius: 4px; margin-right: 5px;}
        .btn-edit:hover { background: #e0a800; }
        .btn-delete { background: #dc3545; color: white; padding: 6px 12px; font-size: 13px; text-decoration: none; border-radius: 4px;}
        ...
        th a { color: white; text-decoration: none; display: flex; align-items: center; justify-content: space-between; width: 100%; font-weight: 600; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; }
